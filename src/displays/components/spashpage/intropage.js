...
const quickLinks = [
    {
        name: "Calendar",
        icon: "https://icon.now.sh/event/2B2F3A/70",
        to: "/events/"
    },
    {
        name: "O-Week",
        icon: "https://icon.now.sh/people/2B2F3A/70",
        href: "https://mcmurtryoweek.wixsite.com/home-page"
    },
    {
        name: "Book a Room",
        icon: "https://icon.now.sh/event_note/2B2F3A/70",
        to: "/roomreservations/"
    },
    {
        name: "Contact",
        icon: "https://icon.now.sh/question_answer/2B2F3A/70",
        to: "/contact/"
    }
]
...
const Intro = () => (
    <div className='intro-page'>
        <Box className='yurt-graphic'>
            <Image src={Yurt} />
        </Box>
        <Box className='quick-links-title' width={[0.6, 0.35]} ml='auto' mr='auto'>
